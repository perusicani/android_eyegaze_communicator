...
public class OpenCVHaarCascadeDetection {

    public static Rect[] detectFaces(
        Mat mRgba,
        CascadeClassifier cascadeClassifierFace
    ) {
        // convert into RGB
        Mat mRgb = new Mat();
    ...
    public static Mat CascadeRec(
            Mat mRgba,
            CascadeClassifier cascadeClassifierFace,
            CascadeClassifier cascadeClassifierEye
    ) {
        // loop through all faces
        Rect[] facesArray = detectFaces(mRgba, cascadeClassifierFace);
